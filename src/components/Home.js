          ...
          <div className="row">
            ...
            <div className="col-sm-8 col-md-8 col-lg-8">
              <div className="title-block">
                <h1>Xin Chen</h1>
                <OwlCarousel
                  className="owl-carousel text-rotation owl-theme "
                  loop
                  dots={false}
                  nav={false}
                  margin={0}
          ...
          <div className="row">
            <div className="col-sm-6 col-md-6 col-lg-6">
              <div className="about-me">
                ...
                <p>
                  Hello! I’m Xin Chen.I am a Front End Developer living in
                  Melbourne
                </p>
              </div>
            </div>
            <div className="col-sm-6 col-md-6 col-lg-6">
              <ul className="info-list">
                ...
                <li>
                  ...
                  <span className="value">Blackburn, VIC</span>
                </li>
                <li>
                  <span className="title">e-mail</span>
                  <span className="value">
                    <a href="mailto:email@example.com">fqchenxin@gmail.com</a>
                  </span>
                </li>
              </ul>
            </div>
